...
"   float  num_x = mad(u1.x, m, u2.x);                                                                            \n" \
"   float  num_y = mad(u1.y, m, u2.y);                                                                            \n" \
"   float  num_z = mad(u1.z, m, u2.z);                                                                            \n" \
"   float  den   = m + u2.w;                                                                                      \n" \
"   float  val_x = native_divide(num_x, den);                                                                     \n" \
"   float  val_y = native_divide(num_y, den);                                                                     \n" \
"   float  val_z = native_divide(num_z, den);                                                                     \n" \
...
"   ushort b   = convert_ushort_sat(val.z * 1023.0f);                                                             \n" \
...
"   ushort r   = convert_ushort_sat(val.x * 65535.0f);                                                            \n" \
"   ushort g   = convert_ushort_sat(val.y * 65535.0f);                                                            \n" \
"   ushort b   = convert_ushort_sat(val.z * 65535.0f);                                                            \n" \
"   write_imageui(R,     s, (uint4)  (r >> CHAR_BIT, 0u, 0u, 0u));                                                \n" \
"   write_imageui(G,     s, (uint4)  (g >> CHAR_BIT, 0u, 0u, 0u));                                                \n" \
